...
export class MoreOffersComponent implements OnInit {
  ...
  getOffers(event?:PageEvent) {
    this.ChangePage(event);
    this.productService.getAllNewOffers(this.skip,this.pageSize).subscribe((response) => {
      console.log('////////////////////////////////////////')
      ...
      console.log('////////////////////////////////////////')
         ...
         this.Offers.forEach(product => {           
                //  product.AddedToCart = this.cartService.isProductExist(product.ID);
                 //console.log("product.AddedToCart : "+product.AddedToCart);
             });
